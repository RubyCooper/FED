...
function checkCeilingImageSize(){
    ...
    var ceilingImageHeight = document.querySelector('div:nth-of-type(1) img:nth-of-type(1)').clientHeight;
...
function like(){
    ...
    if (likeButton.checked == true){
        ...
        // vraagt waar de huidige film in de array staat
...
// zorgt ervoor dat de juiste plek in de array vervangen wordt (door niets)
    ...
    if (likeToggle.checked == true && likedMoviesArray.length >= 1) {
        ...
        if (direction == 'back' || direction == 'ArrowLeft')  {
            ...
            if (currentArrayPosition < 0) {
                // lengte loopt altijd 1 voor dan de array daarom -1
